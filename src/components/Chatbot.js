function Chatbot(){
    ...
    //     p2.textContent = chatbotMsgList[x];
    ...
    function sendMsg() {
        ...
        if(str==="hi" || str==="hello")
        {
            ...
            str2="2.Query on Rawmaterials";
            p5.textContent = str2;
            chatContainer.appendChild(div5);
        }
        else if(str==="1" ||str==="query on products")
        {
        ...
        else if(str==="2" || str==="query on Rawmaterials")
        {
            str2="Explain your problem In detail";
            p2.textContent = str2;
            chatContainer.appendChild(div2);
